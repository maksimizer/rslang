      ...
      <div class="card-content">
          <div class="card-word-wrapper">
              <div class="card-word">
                  ...
                  <div class="audio-btn word-audio-btn">
                    <audio src="${this.serverRequests.baseUrl}/${word.audio}"></audio>
                  </div>
              </div>
          </div>
          <div class="card-meaning-wrapper">
              ...
              <div class="audio-btn word-meaning-audio-btn">
                <audio src="${this.serverRequests.baseUrl}/${word.audioMeaning}"></audio>
              </div>
          </div>
          <div class="card-example-wrapper">
              ...
              <div class="audio-btn word-example-audio-btn">
                <audio src="${this.serverRequests.baseUrl}/${word.audioExample}"></audio>
              </div>
          </div>
      </div>
    `;
